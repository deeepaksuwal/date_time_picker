...
import 'package:flutter_datetime_picker/src/datetime_picker_theme.dart' as dp;
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? dp.DatePickerTheme(),
  ...
  final dp.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    dp.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(dp.DatePickerTheme theme) {
  ...
  Widget _renderItemView(dp.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(dp.DatePickerTheme theme) {
